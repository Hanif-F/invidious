...
[asset inventory](../tests/frontend/asset-baseline.json) define asset accounting, including an advisory 35 KiB stylesheet/shared-asset
target and separate preview checks. Intentional visual variety may exceed the
CSS/JS target; report size and growth without failing solely on that threshold.
